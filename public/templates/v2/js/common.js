...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.numbersAnimation').forEach(element => {
        var animation = bodymovin.loadAnimation({
            container: element,
            path: `/templates/v2/js/numbers-${element.dataset.lang}.json`,
            renderer: 'svg',
            loop: true,
            autoplay: true,
        })
    ...
    function filterKeywords(modal, title) {
        ...
        const emptyText = filtersTitleDate.lastElementChild.innerHTML;
        ...
        modalFiltersInputs.forEach((e, i, a) => {
            ...
            function clearFilters() {
                ...
                filtersTitleDate.lastElementChild.innerHTML = emptyText;
