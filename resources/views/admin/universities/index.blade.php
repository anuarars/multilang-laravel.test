...
@section('content')
    ...
    <div class="col-auto mt-2 mb-2">
        <a class="btn btn-primary ms-2" href="{{ route('admin.universities.create') }}">Добавить язык</a>
    </div>
    <div class="tab-content">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-nowrap card-table">
                        ...
                        @foreach ($universities as $university)
                            <tr>
                                <td>{{ $university->id }}</td>
                                <td style="white-space: nowrap;">{{ $university->translate('ru')->name }}
                                </td>
                                <td class="text-end">
                                    <!-- Dropdown -->
                                    <div class="dropdown text-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.universities.edit', $university->id) }}" class="dropdown-item">
                                                Изменить
                                            </a>
                                            {!! Form::open([
                                        'method' => 'DELETE',
                                        'route' => ['admin.universities.destroy', $university->id],
        ...
        {!! $universities->links('vendor.pagination.dashkit') !!}
    </div>
@endsection