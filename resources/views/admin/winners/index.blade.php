...
@section('content')
    ...
    <div class="col-auto mt-2 mb-2">
        <a class="btn btn-primary ms-2" href="{{ route('admin.winners.create') }}">Добавить победителя</a>
    </div>
                        ...
                        <td class="text-end">
                            ...
                            <div class="dropdown text-center">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('admin.winners.edit', $winner->id) }}" class="dropdown-item">
                                        Изменить
                                    </a>
                                    {!! Form::open([
                                'method' => 'DELETE',
                                'route' => ['admin.winners.destroy', $winner->id],
