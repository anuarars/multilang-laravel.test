...
<div class="col-auto mt-2 mb-2">
    <a class="btn btn-primary ms-2" href="{{ route('admin.partners.create') }}">Создать партнера</a>
</div>
                            ...
                            <td class="text-end">
                                ...
                                <div class="dropdown text-center">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route('admin.partners.edit', $item->id) }}" class="dropdown-item">
                                            Изменить
                                        </a>
                                        <a href="{{ route('admin.partners.show', $item->id) }}" class="dropdown-item">
                                            Посмотреть
                                        </a>
                                        {!! Form::open([
                                    'method' => 'DELETE',
                                    'route' => ['admin.partners.destroy', $item->id],
