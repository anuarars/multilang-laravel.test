...
@section('content')
    ...
    <div class="col-auto mt-2 mb-2">
        <a class="btn btn-primary ms-2" href="{{ route('admin.degrees.create') }}">Добавить язык</a>
    </div>
    <div class="tab-content">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-nowrap card-table">
                        ...
                        @foreach ($degrees as $degree)
                            <tr>
                                <td>{{ $degree->id }}</td>
                                <td style="white-space: nowrap;">{{ $degree->translate('ru')->name }}
                                </td>
                                <td class="text-end">
                                    <!-- Dropdown -->
                                    <div class="dropdown text-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.degrees.edit', $degree->id) }}" class="dropdown-item">
                                                Изменить
                                            </a>
                                            {!! Form::open([
                                        'method' => 'DELETE',
        ...
        {!! $degrees->links('vendor.pagination.dashkit') !!}
    </div>
@endsection