...
<div style="position: absolute; height:40px; width: 100%; background-color: #000;opacity: 0.7; color: #fff; display:flex; justify-content: start; align-items:center;">
    <a href="{{route('admin.news.edit', $news->id)}}" style="color:#fff; font-size: 20px; text-decoration: none; margin-left: 10px;">Назад</a>
    <a href="{{route('admin.news.index')}}" style="color:#fff; font-size: 20px; text-decoration: none; margin-left: 10px;">Сохранить</a>
</div>
@endsection
...
<section class="research pb200">
        ...
        <div class="col-md-9 research__column">
          <div class="research__group-text">
            ...
            <div class="video-wrap">
              <div class="video LazyVideoYt" data-id="7qBfdcI-d1Q" data-alt="" data-params="modestbranding=1&showinfo=0&controls=1&vq=hd720" tabindex="0">
                <div class="video__play h5">
                  <svg width="9" height="13" viewBox="0 0 9 13" fill="none">
                    <path d="M0 1.95576C0 1.13999 0.924163 0.667451 1.58549 1.14508L7.87752 5.68932C8.4302 6.08848 8.4302 6.91152 7.87752 7.31068L1.58549 11.8549C0.924163 12.3325 0 11.86 0 11.0442V1.95576Z" fill="white"/>
                  </svg>
                  Video
                </div>
              </div>
              <span class="gray video-wrap__text">
                Video. Skolkovo energy summer school, <br>
                Russia, Moscow, July 26, 2021. Source: Skolkovo
              </span>
            </div>
            ...
            @foreach ($news as $item)
                <div class="col-md-3 other-news__col">
                    ...
                    <span class="upcoming-item__date gray">
                        {{ Date::parse($item->created_at)->format('d F Y') }}<br>
                        Events
                    </span>
    ...
    {{-- <div class="container">
        <a href="{{ route('news.listing') }}" class="btn-back">@lang('common.go_back')</a>
        <span class="breadcrumb-parent">@lang('home.news.heading')</span>
    </div>
    <section class="page-heading event news-item">
        <div class="container">
            <div class="row">
    ...
    <section class="event-data news-item-data">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    {!! $newsitem->content !!}
                    ...
                    @if ($newsitem->link !== null)
                        <a href="{{ $newsitem->link }}" target="_blank" class="to_post btn btn-primary">@lang('news.news.to_link')</a>
                    @endif
                </div>
            </div>
        </div>
